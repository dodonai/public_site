...
featured: true
featureMain: false
cardText: "Get a comprehensive look at how depositions work, from the initial scheduling to the final use of deposition transcripts in court."
imageAlt: "Images of professionals sharing ideas and information about depositions"
faq:
  - q: "How long does a typical deposition last?"
    a: "Most depositions last between 2 and 7 hours, though the Federal Rules of Civil Procedure set a default limit of 7 hours of testimony in a single day (FRCP Rule 30(d)(1)). Complex cases involving expert witnesses or corporate representatives can take multiple days with court approval. Short depositions for minor witnesses may last only 30 to 60 minutes."
  - q: "Who can be deposed?"
    a: "Any person with relevant knowledge about a case can be deposed, including parties to the lawsuit, eyewitnesses, expert witnesses, corporate representatives (under FRCP Rule 30(b)(6)), treating physicians, and other third parties. Non-party witnesses typically receive a subpoena compelling their attendance."
  - q: "Can you refuse to answer a question during a deposition?"
    a: "In most cases, you must answer deposition questions even if your attorney objects. The main exceptions are questions that would require disclosing privileged information (attorney-client privilege, spousal privilege, or doctor-patient privilege) and questions that are harassing or asked in bad faith. Objections are noted on the record and ruled on later by the judge."
  - q: "What happens if you lie during a deposition?"
    a: "Lying during a deposition constitutes perjury because the deponent is under oath. Consequences can include criminal perjury charges, sanctions from the court, adverse inferences at trial, and impeachment of the witness's credibility using contradictory deposition testimony. The opposing attorney can also read the deposition transcript at trial to highlight inconsistencies."
  - q: "How much does a deposition cost?"
    a: "Deposition costs vary significantly. Court reporter fees typically range from $3 to $10 per page of transcript, with a 100-page transcript costing $300 to $1,000. Videographer fees add $500 to $1,500 per day. Attorney time for preparation and attendance is often the largest expense. Conference room rental may add $200 to $500. AI tools like Dodonai's deposition summary software can reduce post-deposition review costs by generating summaries in minutes instead of hours."
  - q: "Can depositions be taken remotely?"
    a: "Yes, remote depositions via video conference became widely accepted after 2020 and are now standard practice in many jurisdictions. FRCP Rule 30(b)(4) allows depositions to be taken by remote means with stipulation of the parties or court order. Most states have adopted similar provisions. Remote depositions require a court reporter who can administer the oath remotely and a reliable video platform."
---

Depositions are a fundamental part of the pre-trial discovery process in civil litigation, giving each side the opportunity to question witnesses under oath before trial. Whether you are an attorney preparing for your first deposition or a witness who has been asked to appear, understanding how depositions work helps you know what to expect at every stage.
...
A deposition is a formal, out-of-court proceeding where a witness provides sworn testimony in response to questions from attorneys. A [court reporter](/industries/court-reporters/) creates a word-for-word transcript of the testimony, which can later be used in motions, trial preparation, and as evidence in court.
...
Depositions are governed by the Federal Rules of Civil Procedure (FRCP Rules 27-32) in federal court and by analogous state rules in state court. For a detailed walkthrough of the procedural rules, see [Rules Governing Depositions: Navigating the Legal Framework](/blog/rules-governing-depositions-navigating-the-legal-framework/).
...
Deposition transcripts can run hundreds of pages. Attorneys and paralegals create [deposition summaries](/deposition-summary-software/) to distill the key testimony into a usable format. The most common format is a page-line summary, which maps each significant piece of testimony to its transcript location. For a step-by-step walkthrough, see our guide on [how to draft a page-line deposition summary](/blog/how-to-draft-a-page-line-deposition-summary/).

AI tools like Dodonai's [deposition summary software](/deposition-summary-software/) can generate these summaries in minutes, saving hours of manual review time. For guidance on choosing the right tool, see our [litigator's guide to choosing deposition summary software](/blog/choosing-deposition-summary-software-litigators-guide/).
...
For more on how deposition testimony shapes trial strategy, see [The Role of Depositions in Litigation: A Closer Look](/blog/the-role-of-depositions-in-litigation-a-closer-look/) and [Using Depositions as Evidence: A Deep Dive](/blog/using-depositions-as-evidence-a-deep-dive/).
...
| Expedited transcript fee | 25% - 100% surcharge |
| Attorney preparation + attendance | Varies by hourly rate |

The largest cost is usually attorney time. Reducing post-deposition review time — by using [AI deposition summary tools](/deposition-summary-software/) instead of manual summarization — can significantly lower overall case costs.
