...
<div class="flex min-h-[70vh] flex-col items-center justify-center px-4 py-20 sm:py-28">
	<h1 class="text-6xl font-extrabold tracking-tight text-[#282876] sm:text-8xl">
		{$page.status}
	</h1>
	<p class="mt-4 text-xl text-[#8181ac] sm:text-2xl">
		{#if $page.status === 404}
